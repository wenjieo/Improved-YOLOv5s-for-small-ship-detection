...
def plot_one_box(x, img, color=None, label=None, line_thickness=3):
    ...
    color = (0, 0, 255)#color or [random.randint(0, 255) for _ in range(3)]    # #(BGR)
    c1, c2 = (int(x[0]), int(x[1])), (int(x[2]), int(x[3]))
    # plot box center point
    center = (int((x[0] + x[2]) / 2), int((x[1] + x[3]) / 2))
    #cv2.circle(img, center, 5, (0, 0, 255), thickness=-1)
    ...
    if label:
        ...
        #cv2.rectangle(img, c1, c2, (255, 255, 255), -1, cv2.LINE_AA)
        cv2.putText(img, label, (c1[0], c1[1]-5), 0, 0.7, [0, 255, 255], thickness=1, lineType=cv2.LINE_AA)   # 在框上加上标签和置信度
